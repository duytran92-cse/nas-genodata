...
GENODATA_API_URL = 'http://%s:%s' % (os.environ['GENODATA_API_PORT_80_TCP_ADDR'], os.environ['GENODATA_API_PORT_80_TCP_PORT'])
...
#Single sign on
APPLICATION_URL     = 'http://genodata-admin.genopedia.local'
