...
urlpatterns = [
    ...
    url(r'^history$',       handlers.History.as_view(),      name='treatment_history'),
    ...
    url(r'^bulk_update$',   handlers.BulkUpdate.as_view(),   name='treatment_bulk_update'),
    url(r'^list_detail$',   handlers.ListDetail.as_view(),   name='treatment_list_detail'),
]
